...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    /**
     * check if full page after {@link #resetData(List)}, if full, it will enable load more again.
     * <p>
     * 不是配置项！！
     * <p>
     * 这个方法是用来检查是否满一屏的，所以只推荐在 {@link #resetData(List)} 之后使用
     ...
     * @param data
     */
    public void resetData(@Nullable List<T> data) {
        this.mData = data == null ? new ArrayList<T>() : data;
    ...
    /**
     * use data to replace all item in mData. this method is different {@link #resetData(List)},
